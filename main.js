...
function openModalAi(e, modalId) {
    ...
    (MODAL_RS_ID) ? querySelector(MODAL_RS_ID).modal('show') : console.error('Error: modal could not be found'); // Modal show
}
...
function openModalRs(e) {
    ...
    /*--- Create resource elements ---*/
    if (MODAL_RS_ID) {
        querySelector(MODAL_RS_ID).modal('show'); // Modal show

        querySelector(MODAL_RS_ID).on('hidden.bs.modal', function (e) {
